...
export function LoginPage() {
  ...
  return (
    <div>
      ...
      <div className="mt-4 text-center text-sm text-[var(--color-zrho-text-muted)]">
        <Link to="/forgot-password" className="text-[var(--color-zrho-accent)] hover:underline">
          Forgot password?
        </Link>
        <span className="mx-2">·</span>
        <Link to="/signup" className="text-[var(--color-zrho-accent)] hover:underline">
          Create account
        </Link>
      </div>
    </div>
